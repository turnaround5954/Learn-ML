...
hidden_layer_state = 1 ./ (1 + exp(-inputs_to_hidden_units));%choose (c)
...
inputs_to_softmax = hid_to_output_weights' * hidden_layer_state +  repmat(output_bias, 1, batchsize);%choose (a)
