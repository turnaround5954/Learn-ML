...
for epoch = 1:epochs
  ...
  for m = 1:numbatches
    ...
    embed_to_hid_weights_gradient = embedding_layer_state * back_propagated_deriv_1';%choose (b)
    % Options:
    ...
    hid_bias_gradient = sum(back_propagated_deriv_1, 2);%choose (a)
    % Options
    ...
    back_propagated_deriv_2 = embed_to_hid_weights * back_propagated_deriv_1;%choose (a)
    % Options
